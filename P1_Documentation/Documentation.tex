...
\begin{figure}[H]
	...
	\subfigure[modulo mit 2\textsuperscript{3} (8)]{\includegraphics[width=0.50\textwidth]{Img/Zb_mod8.png}}
	\subfigure[modulo mit der Primzahl 7]{\includegraphics[width=0.50\textwidth]{Img/Zb_mod7.png}}
